				...
				<div class="nav-collapse">
					<?php $this->widget('zii.widgets.CMenu',array(
						...
						'items'=>array(
							...
							array('label'=>'Catalogue', 'url'=>array('/itemlist')),
							array('label'=>'Tables', 'url'=>array('/tables')),
							array('label'=>'Customers', 'url'=>array('/clients')),
	  ...
	  <div class="container">
		<div class="row">
			...
			<div id="footer-terms" class="col-md-6">
				© 2012-13 Black Bootstrap. <a href="http://facebook.com/berujiru" target="_blank">Berujiru</a>.
			</div> <!-- /.span6 -->
		 </div> <!-- /row -->
	  </div> <!-- /container -->
	</div>
